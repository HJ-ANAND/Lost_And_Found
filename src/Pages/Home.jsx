  ...
  return (
    <div className="w-full relative font-sans text-slate-800 overflow-x-hidden">
      ...
      <section className="relative w-full min-h-screen flex items-center overflow-hidden">
        <span className="pointer-events-none select-none absolute font-black text-slate-900/[0.05] leading-none tracking-tighter hidden lg:block" style={{ fontSize: "clamp(7rem,14vw,13rem)", top: "2%", left: "-1%" }}>Lost</span>
        <span className="pointer-events-none select-none absolute font-black text-slate-900/[0.05] leading-none tracking-tighter hidden lg:block" style={{ fontSize: "clamp(7rem,14vw,13rem)", bottom: "4%", right: "-1%" }}>Found</span>
        ...
        <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 xl:px-16 flex flex-col lg:flex-row items-center min-h-screen">
          ...
          {/* LEFT: Hero copy */}
          <div className="w-full lg:w-[48%] flex flex-col justify-center pt-28 lg:pt-0 pb-16 lg:pb-0 shrink-0" style={{ left: "-90px", position: "relative", bottom: "-15px" }}>
            ...
            <h1 className="font-extrabold text-[#0B1528] tracking-tight leading-[1.0] mb-7" style={{ fontSize: "clamp(3rem, 6vw, 5.8rem)" }}>
            ...
            <div className="flex flex-wrap gap-6">
              <div className="flex items-center gap-2 text-[14px] text-slate-500 font-medium">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#5cb9a5" strokeWidth="2.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><polyline points="9 12 11 14 15 10" /></svg>
                Verified & Encrypted
              </div>
              <div className="flex items-center gap-2 text-[14px] text-slate-500 font-medium">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#5cb9a5" strokeWidth="2.5"><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>
                Instant AI Matching
              </div>
            </div>
          </div>
          ...
          <div className="hidden lg:block relative flex-1 h-screen min-h-[800px]">
            <div className="absolute bg-white/78 backdrop-blur-2xl p-7 rounded-[2rem] shadow-2xl shadow-slate-300/40 border border-white/70 w-[186px] animate-float-delayed" style={{ top: "430px", left: "-30px", rotate: "-6deg" }}>
            ...
            <div className="absolute bg-white/82 backdrop-blur-2xl p-5 rounded-[2.2rem] shadow-2xl shadow-slate-300/40 border border-white/70 w-[240px] animate-float" style={{ top: "60px", left: "-200px", rotate: "3.5deg" }}>
            ...
            <div className="absolute bg-white/88 backdrop-blur-2xl p-6 rounded-[2.2rem] shadow-2xl shadow-slate-300/50 border border-white/70 w-[276px] animate-float-delayed z-20" style={{ top: "100px", right: "-165px", rotate: "-3deg" }}>
              ...
              <div className="flex items-center justify-between gap-3 bg-white/60 p-3 rounded-2xl border border-white/80 mb-3.5 shadow-inner">
                ...
                <div className="relative w-[62px] h-[82px]">
                  ...
                  <div className="absolute -top-2 -right-2 bg-white rounded-full p-[3px] shadow-md border border-slate-100">
                    <div className="bg-[#5cb9a5] rounded-full p-[3px]"><svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="4"><polyline points="20 6 9 17 4 12" /></svg></div>
                  </div>
                </div>
              </div>
              <p className="text-[11px] text-slate-400 font-medium leading-relaxed">Blue iPhone — matched with report 2 days ago</p>
            </div>
            <div className="absolute bg-white/78 backdrop-blur-2xl py-3 px-4 rounded-full shadow-xl shadow-slate-200/40 border border-white/70 flex items-center gap-2 animate-float-slow" style={{ top: "450px", left: "260px", rotate: "5deg" }}>
            ...
            <div className="absolute bg-white/78 backdrop-blur-2xl px-5 py-4 rounded-[1.6rem] shadow-xl shadow-slate-200/40 border border-white/70 flex items-center gap-4 animate-float" style={{ top: "150px", right: "250px", rotate: "-4deg" }}>
              <div className="w-11 h-11 rounded-full bg-slate-50 flex items-center justify-center shrink-0 shadow-inner border border-white/80">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-slate-600"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" /></svg>
              </div>
              <div>
            ...
            <div className="absolute bg-white/78 backdrop-blur-2xl px-5 py-4 rounded-[1.6rem] shadow-xl shadow-slate-200/40 border border-white/70 flex items-center gap-4 animate-float-slow" style={{ bottom: "140px", left: "130px", rotate: "3deg" }}>
              <div className="w-11 h-11 rounded-full bg-slate-50 flex items-center justify-center shrink-0 shadow-inner border border-white/80">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-slate-600"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><polyline points="9 12 11 14 15 10" /></svg>
              </div>
              <div>
            ...
            <div className="absolute bg-white/78 backdrop-blur-2xl px-6 py-5 rounded-[2rem] shadow-xl shadow-slate-200/40 border border-white/70 animate-float-delayed" style={{ bottom: "150px", right: "30px", rotate: "-3.5deg" }}>
            ...
            <div className="absolute bg-white/78 backdrop-blur-2xl px-5 py-4 rounded-[1.5rem] shadow-xl shadow-slate-200/40 border border-white/70 flex items-center gap-3 animate-float" style={{ bottom: "350px", right: "-200px", rotate: "5deg" }}>
              <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center shrink-0 shadow-inner border border-white/80">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-slate-600"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" /><circle cx="12" cy="10" r="3" /></svg>
              </div>
              <div>
        ...
        <div className="grid md:grid-cols-3 gap-6 xl:gap-8">
          <div className="bg-[#0B1528] p-10 rounded-[32px] shadow-2xl shadow-[#0B1528]/20 flex flex-col items-start gap-6 hover:-translate-y-2 transition-transform duration-300">
            <div className="w-16 h-16 rounded-2xl bg-[#1A2642] flex items-center justify-center shrink-0 border border-white/5">
              <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#5cb9a5" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" /><circle cx="12" cy="10" r="3" /></svg>
            </div>
            <div>
          ...
          <div className="bg-[#0B1528] p-10 rounded-[32px] shadow-2xl shadow-[#0B1528]/20 flex flex-col items-start gap-6 hover:-translate-y-2 transition-transform duration-300">
            <div className="w-16 h-16 rounded-2xl bg-[#1A2642] flex items-center justify-center shrink-0 border border-white/5">
              <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#5cb9a5" strokeWidth="2"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6" /></svg>
            </div>
            <div>
          ...
          <div className="bg-[#0B1528] p-10 rounded-[32px] shadow-2xl shadow-[#0B1528]/20 flex flex-col items-start gap-6 hover:-translate-y-2 transition-transform duration-300">
            <div className="w-16 h-16 rounded-2xl bg-[#1A2642] flex items-center justify-center shrink-0 border border-white/5">
              <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#5cb9a5" strokeWidth="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z" /></svg>
            </div>
            <div>
      ...
      {/* ══════════════════════════════════════════════════════
          FINAL CTA — added from old file, styled in new theme
      ══════════════════════════════════════════════════════ */}
            ...
            <div className="p-10">
              ...
              <div className="space-y-6">
                ...
                <div className="pt-4 border-t border-slate-100">
                  <button className="w-full bg-[#5cb9a5] text-white px-6 py-5 rounded-full font-bold shadow-xl shadow-teal-500/20 hover:bg-[#4ea693] hover:-translate-y-1 transition-all text-lg">Submit Report</button>
                </div>
              </div>
            </div>
          </div>
